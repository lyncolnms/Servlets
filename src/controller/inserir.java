	...
	protected void doPost(HttpServletRequest request,
		...
		if (session.getAttribute("logado") != null) {
			...
			try {
				...
				ps = con.prepareStatement("INSERT INTO cidades (nome, estado) VALUES (?, ?)");
				ps.setString(1, request.getParameter("cidade"));
				ps.setString(2, request.getParameter("estado"));
				ps.executeUpdate();
				...
				out.println("<title>Formulário de Inserção</title>");
